      ...
      orientation:(UIDeviceOrientation)orientation
{
    ...
    CGRect previewBox = [FaceDetecUtil videoPreviewBoxForGravity:gravity
       ...
       fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (features && features.count >0 && image) {
        [self teardownAVCapture];
        if (_delegate && [_delegate respondsToSelector:@selector(didDetectedFaceWithImage:)]) {
            [_delegate didDetectedFaceWithImage:image];
        }
    }
}
